...
$(document).ready(function(){
	...
	fillUsuarios().then(function(){
		$("#user-saldo").html("S/."+ user.saldo.toFixed(2));
	...
	await $.ajax({
		...
		success: function(result){
			...
			if(parsedResult != false){
				...
				console.log("Error recuperandolos datos del usuario");
			}
		}
	});
}
...
function mostarHistorial(libros){
